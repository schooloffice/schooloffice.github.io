...
const FORMULA_ERROR_HINTS = {
  ...
  '#REF!': 'Хибне посилання на клітинку (поза межами таблиці або видалене) чи ім\'я, чий діапазон видалено.',
  '#NAME?': 'Невідома назва функції або діапазону. Перевірте правопис, напр. SUM, або ім\'я в «Дані → Іменовані діапазони».',
