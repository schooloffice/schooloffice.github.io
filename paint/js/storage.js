...
// localStorage — важливо, бо документи тепер бувають великі). Якщо IDB
// недоступний/зависає (приватний режим; headless virtual-time, де open
...
// НОВІШУ копію з обох сховищ. Патерн портовано зі slides/js/storage.js.
(() => {
  const { constants } = window.ArtMalyunky;

  const DB_NAME = 'plus_paint';
  const DB_VERSION = 1;
  const STORE = 'drafts';
  ...
  window.ArtMalyunky.paintStorage = { saveDraft, loadDraft, clearDraft, chooseNewerDraftRecord };
})();
