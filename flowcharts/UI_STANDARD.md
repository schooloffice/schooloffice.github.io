...
- Основні сценарії: створення й перетягування блоків, з'єднання та ручне редагування маршрутів, перевірка логіки схеми, локальні шаблони, експорт PNG/SVG і збереження JSON-проєкту.
