...
- `Ctrl+S` зберігає робочий файл схеми (`.shema`), як і в решті редакторів. PNG — це експорт із меню, без власної комбінації.
...
- Не повертати `Ctrl+S` експорту: PNG не дає продовжити роботу над схемою.
