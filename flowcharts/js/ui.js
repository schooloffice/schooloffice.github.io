(function () {
  ...
  function renderHelpPanelContent(helpPanel) {
    ...
    stepsWrap.innerHTML = `
      ...
      <div class="help-step"><span class="step-num">11</span><span><strong>Шаблони</strong> — меню <strong>Файл → Шаблони схем…</strong> дає готові заготовки: лінійний алгоритм, розгалуження, цикл та інші.</span></div>
      <div class="help-step"><span class="step-num">12</span><span><strong>Перевірити схему</strong> — меню <strong>Редагування → Перевірити схему</strong> знаходить типові помилки (немає «Початку», недосяжні блоки, умова без гілки «Так/Ні»). Натисни на знахідку, щоб побачити проблемний блок.</span></div>
