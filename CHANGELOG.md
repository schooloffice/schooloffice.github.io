...
- **Керування карткою слайда з'являється лише при наведенні.** Кнопки порядку, дублювання й видалення переїхали в overlay поверх мініатюри й показуються на hover або клавіатурному фокусі; на сенсорних пристроях (`@media (hover: none)`) лишаються видимими.
...
- `sw.js`: `CACHE_VERSION` → `office-plus-v37`.
